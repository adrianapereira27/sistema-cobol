...
/* ./.libs/lt-cobcrun.c - temporary wrapper executable for .libs/cobcrun
   Generated by libtool (GNU libtool) 2.4.6

   The cobcrun program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/OC/gnucobol-2.2/libcob/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/OC/gnucobol-2.2/libcob/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "cobcrun"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# cobcrun - temporary wrapper script for .libs/cobcrun\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The cobcrun program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libcob/libcob.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"cobcrun:cobcrun:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"cobcrun:cobcrun:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"cobcrun:cobcrun:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/OC/gnucobol-2.2/libcob/.libs:/usr/local/lib:/usr/local/bin", f);
  fputs (":$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/OC/gnucobol-2.2/libcob/.libs:$PATH\"\n", f);
  fputs ("\n", f);
